...
declare namespace jest {
   ...
   */
  function onGenerateMock<T>(
    cb: (modulePath: string, moduleMock: T) => T,
  ): typeof jest;
  /**
  ...
  interface MockWithArgs<T extends MockableFunction> extends MockInstance<
    ReturnType<T>,
    ArgumentsOf<T>,
  ...
  interface Mock<T = any, Y extends any[] = any, C = any>
    extends Function, MockInstance<T, Y, C> {
    new (...args: Y): T;
    (this: C, ...args: Y): T;
  }
