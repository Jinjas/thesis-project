...
def update_ingredient_line(onto_text: str, prev_ingredient: str, new_ingredient: str, prev_ingredient_type: str, new_ingredient_type: str):
    ...
    new_ingredient_pattern = re.compile(r'\b' + re.escape(new_ingredient) + r'\b')
    ...
    for i, line in enumerate(lines):
        ...
        if in_zone_individual:                
            ...
            line = line.replace(prev_ingredient, new_ingredient).replace(prev_ingredient_type, new_ingredient_type)
...
def main():
    ...
    cocktail_name, updated_onto = update_ingredient_line(onto, prev_ingredient, new_ingredient, prev_ingredient_type, new_ingredient_type)
