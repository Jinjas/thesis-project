...
export default function ActionButton({
  ...
  const variantClasses = {
    ...
    save: "disabled:bg-gray-400 text-white rounded w-min px-3 py-2 bg-gray-700 hover:bg-gray-900",
    expand:
      "disabled:bg-gray-400 text-white rounded w-min px-1 py-1 bg-gray-700 hover:bg-gray-900 text-xs",
    double:
