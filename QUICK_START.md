...
```bash
cd .\thesis-project\
ssh pg56006@cosmo.epl.di.uminho.pt "cat ~/thesis-project/backups/tese-data-20260923-114134.tar.gz" > backups/tese-data-20260923-114134.tar.gz
```
...
put "C:\Users\cramos\Documents\universidadeRodrigo\university\fifthyear\tese\thesis-project\backups\tese-data-20260923-114134.tar.gz" "thesis-project/backups/tese-data-20260923-114134.tar.gz"
bye
```
...
```bash
cd ~/thesis-project
ls -lh backups/tese-data-20260923-114134.tar.gz
gzip -t backups/tese-data-20260923-114134.tar.gz && echo OK
make restore FILE=backups/tese-data-20260923-114134.tar.gz
make restart
make test
```
