...
```bash
cd ~/thesis-project
ls -lh backups/tese-data-20260527-011439.tar.gz
gzip -t backups/tese-data-20260527-011439.tar.gz && echo OK
make restore FILE=backups/tese-data-20260527-011439.tar.gz
make restart
make test
```
